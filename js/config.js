...
export const PASSIVES = {
  ...
  speed_shoes: {
    ...
    name: '特工跑鞋',
    icon: '👟',
    description: '提升特工移動速度 +12%。(燃燒瓶超武配方)',
    maxLevel: 5,
    valuePerLevel: 0.12,
  },
  max_hp_vest: {
    ...
    name: '防彈護甲',
    icon: '🦺',
    description: '生命上限 +30，每秒自動恢復 1 點生命。(足球超武配方)',
    maxLevel: 5,
    valuePerLevel: 30,
  },
  magnet: {
    ...
    name: '強力磁鐵',
    icon: '🧲',
    description: '擴大經驗寶石與掉落物的拾取範圍 +30%。(守護輪盤超武配方)',
    maxLevel: 5,
    valuePerLevel: 0.30,
  },
  cdr_battery: {
  ...
  range_fuel: {
    ...
    name: '高能燃料',
    icon: '⛽',
    description: '所有技能攻擊範圍與彈藥大小 +15%。(火箭超武配方)',
    maxLevel: 5,
    valuePerLevel: 0.15,
  },
};
